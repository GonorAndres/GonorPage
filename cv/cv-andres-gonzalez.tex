...
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, analista de performance marketing en la agencia \textbf{Levely} y co-autor de artículo científico en el IGF-UNAM. Tomo problemas de medición y de una aseguradora (atribución, tracking, pricing, reservas, capital regulatorio) y los llevo a un sistema en producción: modelo, pipeline en \textbf{GCP}, API y dashboard. Practico la formación continua y el trabajo con equipos multidisciplinarios. En \href{https://gonor.me/}{mi página web} comparto lo que aprendo y construyo.
    ...
    \section{Experiencia}
        ...
        \begin{onecolentry}
            ...
            \begin{highlights}
                \item Construyo la capa de datos que conecta ventas, analítica y publicidad: implemento conversiones \textbf{server-side}, concilio fuentes y convierto señales de compra en análisis y monitores para orientar la inversión. Complemento con CRO cuantitativo y cualitativo de sesiones para priorizar mejoras con criterios estadísticos y humanos. \textit{BigQuery, GA4, PostHog, Clarity}.
            \end{highlights}
            \end{onecolentry}
        ...
        \begin{onecolentry}
            ...
            \begin{highlights}
                \item Co-autor del \href{https://www.sciencedirect.com/science/article/abs/pii/S0895981126003305}{artículo sobre predicción de erupciones del Popocatépetl} con \textbf{procesos de renovación Weibull}. Supervisión: \hrefWithoutArrow{https://scholar.google.com/citations?user=lDD0DZQAAAAJ}{Dr.\ Hugo Delgado-Granados} (IGF-UNAM).
            \end{highlights}
            \end{onecolentry}
